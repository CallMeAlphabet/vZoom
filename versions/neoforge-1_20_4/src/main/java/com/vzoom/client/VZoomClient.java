...
public class VZoomClient {
    ...
    public static class ModBus {
        ...
        @SubscribeEvent
        public static void onRegisterLayers(net.neoforged.neoforge.client.event.RegisterGuiOverlaysEvent e) {
            e.registerAboveAll(new ResourceLocation(MOD_ID, "zoom_hud"),
                    (gui, gg, dt, w, h) -> ZoomHud.render(gg, dt));
        }
    }
    ...
    public static class GameBus {
        @SubscribeEvent
        public static void onTick(net.neoforged.neoforge.event.TickEvent.ClientTickEvent e) {
